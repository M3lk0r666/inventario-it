 <nav class="fixed top-0 z-50 w-full bg-white border-b border-border-soft">
         ...
         <div class="flex items-center justify-between">
             <div class="flex items-center justify-start rtl:justify-end">
                 <button data-drawer-target="top-bar-sidebar" data-drawer-toggle="top-bar-sidebar"
                     ...
                     class="sm:hidden text-gray-500 bg-transparent border border-transparent hover:bg-gray-100 focus:ring-2 focus:ring-gray-200 font-medium leading-5 rounded-lg text-sm p-2 focus:outline-none">
