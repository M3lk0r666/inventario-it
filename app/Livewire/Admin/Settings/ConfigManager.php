...
class ConfigManager extends Component
{
    ...
    // Cartas
    public string $letter_folio_prefix = '';

    public string $letter_next_number = '';

    public string $letter_intro_text = '';
    ...
    public function mount(): void
    {
        ...
        $this->letter_folio_prefix = Setting::get('letter_folio_prefix', 'CR');
        $this->letter_next_number = Setting::get('letter_next_number', '1');
        $this->letter_intro_text = Setting::get('letter_intro_text', '');
    ...
    public function saveLetters(): void
    {
        $this->authorize('settings.edit');
        $this->validate([
            'letter_folio_prefix' => ['required', 'string', 'max:10'],
            'letter_next_number' => ['required', 'integer', 'min:1'],
            'letter_intro_text' => ['nullable', 'string', 'max:2000'],
        ], [], [
            'letter_folio_prefix' => 'prefijo', 'letter_next_number' => 'consecutivo', 'letter_intro_text' => 'texto',
        ]);

        Setting::set('letter_folio_prefix', $this->letter_folio_prefix);
        Setting::set('letter_next_number', $this->letter_next_number);
        Setting::set('letter_intro_text', $this->letter_intro_text);

        $this->dispatch('toast', type: 'success', message: 'Configuración de cartas guardada.');
    }
